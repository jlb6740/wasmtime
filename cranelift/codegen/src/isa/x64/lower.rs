    ...
    match op {
        ...
        Opcode::Ishl | Opcode::Ushr | Opcode::Sshr => {
            ...
            if tyD == tySL && (tyD == types::I32 || tyD == types::I64) {
                ...
                ctx.emit(Inst::shift_r(is64, how, 0 /*%cl*/, regD));
            } else {
                unimplemented = true;
            }
        }
        ...
        Opcode::Uextend | Opcode::Sextend => {
            ...
            match (tyS, tyD, isZX) {
                (types::I8, types::I64, false) => {
                    ctx.emit(Inst::shift_r(true, ShiftKind::Left, 56, regD));
                    ctx.emit(Inst::shift_r(true, ShiftKind::RightS, 56, regD));
                }
                _ => {
                    unimplemented = true;
                }
        ...
        Opcode::FallthroughReturn | Opcode::Return => {
            for i in 0..ctx.num_inputs(iri) {
                ...
                ctx.emit(Inst::mov_r_r(/*is64=*/ true, src_reg, retval_reg));
            }
