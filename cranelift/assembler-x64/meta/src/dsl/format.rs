...
impl Location {
    ...
    pub fn uses_memory(&self) -> bool {
        use Location::*;
        match self {
            al | cl | ax | eax | rax | imm8 | imm16 | imm32 | r8 | r16 | r32 | r64 | xmm1 | xmm2 | xmm3
            | ymm1 | ymm2 | ymm3 | zmm1 | zmm2 | zmm3 => false,
            rm8 | rm16 | rm32 | rm64 | rm128 | xmm_m128 | ymm_m256 | zmm_m512 => true,
        }
    }
    ...
    pub fn uses_variable_register(&self) -> bool {
        ...
        match self {
            ...
            r8 | r16 | r32 | r64 | rm8 | rm16 | rm32 | rm64 | rm128 | xmm1 | xmm2 | xmm3 | ymm1 | ymm2
            | ymm3 | zmm1 | zmm2 | zmm3 | xmm_m128 | ymm_m256 | zmm_m512 => true,
        }
    }
