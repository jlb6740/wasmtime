...
impl dsl::Operand {
    ...
    pub fn generate_type(&self) -> String {
        ...
        match self.location {
            ...
            xmm1 | xmm2 | xmm3 | ymm1 | ymm2 | ymm3 | zmm1 | zmm2 | zmm3 => format!("Xmm<R::{mut_}Xmm>"),
...
impl dsl::Location {
    ...
    pub fn generate_to_string(&self, extension: dsl::Extension) -> String {
        ...
        match self {
            ...
            xmm_m32 | xmm_m64 | xmm1 | xmm2 | xmm3 | ymm1 | ymm2 | ymm3 | zmm1 | zmm2 | zmm3 | xmm_m128 | ymm_m256
            | zmm_m512 | m8 | m16 | m32 | m64 => format!("self.{self}.to_string()"),
        }
    }
